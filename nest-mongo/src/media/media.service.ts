...
export class MediaService {
    ...
    constructor(
        ...
        this.region = Constants.aws_region;
        this.accessKeyId = Constants.aws_access_key;
        this.secretAccessKey = Constants.aws_access_key;
        this.publicBucketName = Constants.aws_public;
    }
